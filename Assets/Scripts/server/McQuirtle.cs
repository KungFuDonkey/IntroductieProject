...
public class McQuirtle : Player
{
    ...
    public void basicAttack()
    {
        ...
        ServerSend.Projectile(this, 8, new WaterBall((int)GameManager.projectileNumber, projectileSpawner.position, rotation, _inputDirection * status.runSpeed, id));
        Debug.Log("shooting");
    }
    ...
    public void qAttack()
    {
        ...
        Quaternion rotation = Quaternion.Euler(status.verticalRotation, avatar.rotation.eulerAngles.y, avatar.rotation.eulerAngles.z);
        ServerSend.Projectile(this, 9, new WaterBall((int)GameManager.projectileNumber, projectileSpawner.position, rotation, _inputDirection * status.runSpeed, id));
        Debug.Log("shooting");
    }
    ...
    public void eAttack()
    {
        ...
        Quaternion rotation = Quaternion.Euler(status.verticalRotation, avatar.rotation.eulerAngles.y, avatar.rotation.eulerAngles.z);
        ServerSend.Projectile(this, 10, new WaterBall((int)GameManager.projectileNumber, projectileSpawner.position, rotation, _inputDirection * status.runSpeed, id));
        Debug.Log("shooting");
    }
}
